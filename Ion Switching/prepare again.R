...
test_data$batches<- factor((test_data$time - 0.0001)%/%50-10)
...
DF_te <- DF_te[,-which(colnames(DF_te) %in% c("signal_M1001"))]
...
write_csv(DF_tr,"newtrain_.csv")
write_csv(DF_te,"newtest_.csv")
